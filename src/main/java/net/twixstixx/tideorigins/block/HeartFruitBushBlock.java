...
public class HeartFruitBushBlock
extends PlantBlock
implements Fertilizable {
    ...
    public HeartFruitBushBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            HeartFruitBushBlock.dropStack(world, pos, new ItemStack(TideOriginsMod.HEARTFRUIT, j + (bl ? 1 : 0)));
